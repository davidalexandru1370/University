...
class NegativeCycleException : std::exception {
private:
	std::string message;

public:
	NegativeCycleException(std::string mess);
...
public:
	...
	std::vector<int> bfs(int start_node, int end_node);
	std::vector<int> ford(int start_node, int end_node);
